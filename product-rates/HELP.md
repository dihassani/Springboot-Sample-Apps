...
* The original package name 'com.demo.product-rates' is invalid and this project uses 'com.demo.productrates' instead.
...
* [Spring Configuration Processor](https://docs.spring.io/spring-boot/docs/3.0.5-SNAPSHOT/reference/htmlsingle/#appendix.configuration-metadata.annotation-processor)
